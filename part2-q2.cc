/* -*- Mode:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- */
 ...
 //question 2 part 2: the base program is tcp-validation.cc and has been modified for project requirements.
...
//setting the advertised window size of receiver to 30 for flow 1 and 6 packets for flow 2
  ...
  //TcpSocketBase->GetAttribute("MaxWindowSize");
  ...
  proto->SetAttribute ("SocketType", TypeIdValue (secondTcpTypeId));
  //proto->SetAttribute ("MaxWindowSize",UintegerValue(6*1448)); //6 packets into bytes
